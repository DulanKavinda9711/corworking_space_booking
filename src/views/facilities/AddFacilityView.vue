          ...
          <div class="bg-white rounded-xl shadow-card overflow-visible">
            <div class="p-8 space-y-16">
              ...
              <div class="flex justify-end space-x-4 pt-6 border-t border-gray-200">
                ...
                <button type="submit"
                  :disabled="isLoading"
                  class="px-6 py-3 bg-primary-600 text-white rounded-lg hover:bg-primary-700 disabled:bg-primary-400 disabled:cursor-not-allowed transition-colors flex items-center space-x-2">
