<template>
  <div
    ...
    <div v-if="showForgotPassword"
      class="fixed inset-0 bg-gray-600 bg-opacity-50 backdrop-blur-sm overflow-y-auto h-full w-full z-50 flex items-center justify-center p-4">
      <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full border border-gray-100">
        <div class="p-6">
          ...
          <div v-if="!forgotPasswordSuccess">
            ...
            <form @submit.prevent="handleForgotPassword" class="space-y-4">
              <div>
                ...
                <input id="forgot-email" name="forgot-email" type="email" required v-model="forgotPasswordForm.email"
          ...
          <div v-else class="text-center">
            ...
            <button @click="showPasswordReset"
        ...
        <div class="p-6">
          ...
          <form @submit.prevent="handlePasswordReset" class="space-y-4">
            <div>
              ...
              <input id="reset-code" name="reset-code" type="text" required v-model="resetForm.code"
            ...
            <div>
              ...
              <input id="reset-new-password" name="reset-new-password" type="password" required
            ...
            <div>
              ...
              <input id="reset-confirm-password" name="reset-confirm-password" type="password" required
            ...
            <div class="flex justify-end space-x-3 pt-4">
              <button type="button" @click="closeResetForm"
                class="px-6 py-2.5 text-sm font-semibold text-gray-700 bg-gray-100 hover:bg-gray-200 rounded-xl transition-all duration-200">
                Cancel
              </button>
...
const handleLogin = async () => {
  ...
  try
  {
    ...
    console.log('Login response status code:', response.status_code)
    ...
    if (response.status_code === 200 && response.data) {
      ...
      if (role === 'Super Admin' || role === 'SuperAdmin') {
        ...
        sessionStorage.setItem('loginSuccessMessage', 'Welcome superadmin. login successfully.')
        router.push('/dashboard')
        return
      }

      // For regular users, redirect to dashboard with success message
      sessionStorage.setItem('loginSuccessMessage', `Welcome ${username_from_token}. login successfully`)
      router.push('/dashboard')
    } else if (response.status_code === 403) {
      // Password change required - redirect to onboarding
