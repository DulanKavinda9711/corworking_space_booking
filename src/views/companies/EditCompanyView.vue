    ...
    <div class="space-y-6">
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center space-x-4">
          ...
          <div>
            <h1 class="text-xl font-bold text-gray-900">Edit Company Details</h1>
          </div>
        </div>
      </div>
                  ...
                  <div>
                    ...
                    <div class="flex items-center space-x-4">
                      <div class="w-16 h-16 bg-gray-100 rounded-lg flex items-center justify-center border-2 border-dashed border-gray-300 hover:border-primary-400 transition-colors">
                        <img v-if="form.logoUrl" :src="form.logoUrl" alt="Company Logo" class="w-full h-full object-cover rounded-lg" />
...
const loadCompanyData = async (companyId: string) => {
  try {
    ...
    const mockCompanyData = {
      ...
      status: 'active' as 'active' | 'inactive',
      logoUrl: '' // Add actual logo URL if available
    }
    
    form.value = mockCompanyData
